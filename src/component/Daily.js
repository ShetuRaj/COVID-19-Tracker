...
class Daily extends Component{
  ...
  componentDidMount() {
    ...
    .then(response => {
        ...
        {
            if(sortable[i][0]=="date")
                date=sortable[i][1]
            if(sortable[i][0]!="date" && sortable[i][0]!="status" && sortable[i][0]!="tt" && sortable[i][0]!="dd")
            {   
        ...
        // const postings = response.data.statewise
        // //console.log(postings)
        // var states=[]
        // var num=[]

        // for (var i=1;i<postings.length;i+=1) {
        //   states[i-1]=postings[i].state
        //   num[i-1]=postings[i].confirmed
        // }
        //console.log(states)
        //console.log(num)
